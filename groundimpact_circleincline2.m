function [value,isterminal,direction] = groundimpact_circleincline2(t,q)
...
if P1>-1
 ...
 y = -(l(1)*cos(q(1))+l(2)*cos(q(2))+l(3)*cos(q(3))+Q1)-(l(1)*sin(q(1))+l(2)*sin(q(2))+l(3)*sin(q(3))-P1)*tand(2); %inclined plane y-mx=0;
