function [value,isterminal,direction] = groundimpact_flat(t,q)
...
%    y=(-l(1)*cos(q(1))-l(2)*cos(q(2))-l(3)*cos(q(3))-Q1)-.1*(cos(1.5*(l(1)*sin(q(1))+l(2)*sin(q(2))+l(3)*sin(q(3))-P1))-1);%cosine_surface y=.1*(cos(1.5*x)-1);
       y = -(l(1)*cos(q(1))+l(2)*cos(q(2))+l(3)*cos(q(3))+Q1)-(l(1)*sin(q(1))+l(2)*sin(q(2))+l(3)*sin(q(3))-P1)*tand(0); %inclined plane y-mx=0;
% 
% value = 1;
