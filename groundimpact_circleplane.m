function [value,isterminal,direction] = groundimpact_circleplane(t,q)
...
if P1>-0.5
 ...
 %y = -(l(1)*cos(q(1))+l(2)*cos(q(2))+l(3)*cos(q(3))+Q1)-(l(1)*sin(q(1))+l(2)*sin(q(2))+l(3)*sin(q(3))-P1)*tand(0) - 0.067; %plane y-c=0;
 y = -(l(1)*cos(q(1))+l(2)*cos(q(2))+l(3)*cos(q(3))+Q1)-(l(1)*sin(q(1))+l(2)*sin(q(2))+l(3)*sin(q(3))-P1)*tand(4) - 0*0.0156; %plane y-c=0;
