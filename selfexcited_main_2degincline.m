...
savex1 = [];savex2= [];savex3= [];savex4= [];savex5= [];savey1= [];savey2= [];savey3= [];savey4= [];savey5= [];savezmp=[];saveth1=[];saveth2=[];saveth3=[];saveAB=[];saveA=[];saveB=[];
 ...
 phi=0;
 %kd=0; %flat_surface
  kd=0.28;%2 degree inclined plane
...
% k=6; %curved feet
q01 = -0.14+pi;
   q0 = [q01;pi-q01;pi-q01;7.53*(pi-q01);0;0];%normalworking condition
...
options2 = odeset('Events',@groundimpact_2degincline);%,'MaxStep',2.5000e-05);
...
%close all
     %    Display1_2degincline(q,t,P1,Q1) % for seeing the video
             Display1_2degincline2(q,t,P1,Q1) % for obtaining the stick diagram
%%
% savecg(end)-x0
